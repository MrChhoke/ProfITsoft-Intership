...
/**
 * This class represents a DTO (Data Transfer Object) for technology vacancy statistics.
 * It extends the AbstractDto class and includes a map of technology names to vacancy counts.
 *
...
public class TechnologyVacancyStatsDto extends AbstractDto {

    /**
     * This field represents a map of technology names to vacancy counts.
     * The key is the technology name and the value is the vacancy count.
     */
    @JacksonXmlProperty(localName = "vacancy-count-by-technology-statistic")
    @JsonSerialize(using = MapSerializer.class)
    protected Map<String, Long>  vacancyCountByTechnology;
